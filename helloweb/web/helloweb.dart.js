...
$.reverseText$bailout = function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      text = env0;
      break;
  ...
  switch (state0) {
    ...
    case 2:
      var text, buffer, t1, i, t3;
      state0 = 0;
      t3 = $.getInterceptor$JSArray(buffer);
      for (; $.geB(i, 0); i = $.sub(i, 1))
        t3.add$1(buffer, t1.operator$index$1(text, i));
...
//@ sourceMappingURL=helloweb.dart.js.map